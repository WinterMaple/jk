...
<body onSelectStart="return true">
	...
	<div id="userInfo" style="z-index:999;" onclick="HideLoginDiv()"
		...
		<img src="${ctx}/skin/default/images/title/avataronline.gif"
			border="0" style="margin-top:-1px;" /> 您好：<strong>${_CURRENT_USER.realName}</strong>&nbsp;&nbsp;|
	...
	<a id="memos" style="cursor:pointer;" href="${ctx}/fmain.action"
					...
					<div id="mask">
						<div id="menuContent">
							<span id="topmenu"
								...
								onclick="top.leftFrame.location.href='cargoLeft.action';top.main.location.href='cargoMain.action';linkHighlightMenu(this);">货运管理</span><span
								id="tm_separator"></span><span id="topmenu"
