...
<script type="text/javascript"
	src="${ctx}/components/jquery-ui/jquery-3.2.1.js"></script>
...
<body id="left_frame">
			...
			<div class="panel-header">
				...
				<div class="panel-content">
					<ul>
						...
						<li><a href="#" onclick="linkHighlighted(this)" id="aa_2">系统使用反馈</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<div id="sidebar" class="sidebar">
		...
		<div class="panel">
			<div class="panel_icon">
				<img src="${ctx}/skin/default/images/icon/cubes.png" />
			</div>
			<div class="panel-header">
				...
				<div id="customerMenu">
					<div class="FastMenu">
						<img src="${ctx}/skin/default/images/notice.gif"
							style="margin-right:5px;" border="0" /><font color="gray">您还没定义您的菜单</font>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="sidebar" class="sidebar">
		...
		<div class="panel">
			<div class="panel_icon">
				<img src="${ctx}/skin/default/images/icon/businessman2.png" />
			</div>
			<div class="panel-header">
				<div class="panel-title">用户设定</div>

				<div class="panel-content">
					<ul>
						<li><a href="#" id="aa_2" onclick="linkHighlighted(this)">个人信息修改</a>
						</li>
					</ul>
				</div>
			</div>
