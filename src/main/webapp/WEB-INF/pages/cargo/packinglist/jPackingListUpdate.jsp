					...
					<table class="commonTable" cellspacing="1">
						...
						<tr>
							...
							<td class="tableContent"><textarea name="descriptions"
									style="height:120px;">${obj.descriptions}</textarea></td>
						</tr>
					</table>
				</div>
			</div>
